...
import com.sparta.sparta_spring.entity.UserRoleEnum;
...
//          return ResponseEntity.status(HttpStatus.BAD_REQUEST)
            return ResponseEntity.badRequest()  // status : bad request
                    .body(BlogDto.SendMessage.builder()  // body : SuccessResponseDto (statusCode, msg)
        ...
        return ResponseEntity.ok()
                .body(BlogDto.SendMessage.builder()   // status : ok
